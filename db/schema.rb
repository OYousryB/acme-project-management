...
ActiveRecord::Schema.define(version: 2021_10_14_232315) do

  create_table "auth_tokens", charset: "latin1", force: :cascade do |t|
    t.string "token"
    t.boolean "expired"
  ...
  create_table "participants", charset: "latin1", force: :cascade do |t|
    t.bigint "project_id"
